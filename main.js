...
function showMovies(data) {
    ...
    data.forEach(movie => {
        ...
        movieEl.innerHTML = `
            <div class="movie">
                <img onclick="bukaPopup(${id})" class="posterFilm" src="${poster_path? IMG_URL+poster_path: "http://via.placeholder.com/1080x1580" }" alt="${title}">
        ...
        moviePopup.innerHTML =`
            <div class="popup" id="${id}" >
                <img class="posterFilmPopup" src="${poster_path? IMG_URL+poster_path: "http://via.placeholder.com/1080x1580" }">
